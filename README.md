...
**Specialties:** Raspberry Pi · Network Infrastructure · Linux Automation · IoT · Marine Technology

---

## 📦 Featured Projects

### 🖨️ [raspi-projects](https://github.com/skapenAI/raspi-projects)
Modular Raspberry Pi automation toolkit – print servers, VPN, home automation.
Built with a professional development standard: every project includes `setup`, `uninstall`, `rollback`, and `test` scripts.

---

## 💡 Philosophy

- **Practical over perfect** – solutions that work in the real world
- **Simple over complex** – if a sailor can use it in rough seas, anyone can
- **Open and documented** – clear code, clear docs, clear purpose
- **AI-collaborative** – using AI as a tool to build better, faster

---

## 📫 Get in Touch

[![GitHub](https://img.shields.io/badge/GitHub-skapenAI-181717?style=flat&logo=github)](https://github.com/skapenAI)

---

*🌊 Building technology that works – on land and at sea.*
